...
BIDS_data_path = r''  # BIDS path to data
Task = ''  # Name of the task of interest
tmin, tmax = (0, 2)  # Epoch duration (start, stop) in seconds
...
# All data will be saved as ID_cleaned in the involvement directory of this script
